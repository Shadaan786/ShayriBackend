...
channel.consume(queue, msg=>{
 ...
 if(media_data.fileType === "image&audio"){
        ...
        const check2 = (async()=>{
          ...
          const uploaded_result =      await dbImageUploader(media_data.payload.fileData, media_data.payload.userId, imageUrl, videoUrl);
        ...
        check6();
    }else if(media_data.fileType === 'albumBg'){
        const check7 = (async()=>{
            const url = await cloudfareUploader(media_data.payload.path);
